...
def main():
    ...
    ## Model specification
    model = nn.Sequential(
              nn.Conv2d(1, 32, (3, 3)), #A convolutional layer with 32 filters of size 3x3
              nn.ReLU(), #A ReLU nonlinearity
              nn.MaxPool2d((2, 2)), #A max pooling layer with size 2x2
              nn.Conv2d(32, 64, (3, 3)), #A convolutional layer with 64 filters of size 3x3
              nn.ReLU(), #A ReLU nonlinearity
              nn.MaxPool2d((2, 2)), #A max pooling layer with size 2x2
              nn.Flatten(), #A flatten layer
